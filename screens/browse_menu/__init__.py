...
from .ui import create_category_chips, create_search_field, create_pagination_controls
from .pagination import create_menu_loader, create_pan_handler
...
def browse_menu_screen(page: ft.Page, current_user: dict, cart: list, goto_cart, goto_profile, goto_history, goto_logout):
    ...
    # Pan handler for swipe gestures
    on_pan = create_pan_handler(current_page, total_pages, selected_category, search_field, load_menu)
