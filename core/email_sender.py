...
class EmailSender:
    def __init__(self):
        ...
        self.sender_name = os.getenv("SMTP_SENDER_NAME", "Food Delivery App")
    ...
    def send_verification_email(self, to_email: str, full_name: str, token: str, expiry_minutes: int = 10):
        ...
        text_body = (
            f"Hello {full_name},\n\n"
            "Thanks for signing up for Food Delivery App.\n\n"
  ...
  <body style=\"font-family: Arial, sans-serif; color: #222;\">
        <div style="max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 20px;">
                ...
                <p>Thanks for signing up for <strong>Food Delivery App</strong>. Use this code to complete your signup:</p>
                ...
                <p style="margin-top: 16px; color: #666;">Food Delivery App Team</p>
            </div>
    </div>
  </body>
</html>
"""
    ...
    def send_password_reset_email(self, to_email: str, full_name: str, token: str, expiry_minutes: int = 10):
        subject = "Your Food Delivery password reset code"
        text_body = (
            f"Hello {full_name},\n\n"
            "We received a request to reset your Food Delivery password.\n\n"
...
<html>
  <body style=\"font-family: Arial, sans-serif; color: #222;\">
        <div style="max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 20px;">
                <p style="margin-top: 0;">Hello <strong>{full_name}</strong>,</p>
                <p>Use this code to reset your <strong>Food Delivery App</strong> password:</p>
